...
type BlogServiceClient interface {
	CreatBlog(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*BlogId, error)
...
func (c *blogServiceClient) CreatBlog(ctx context.Context, in *Blog, opts ...grpc.CallOption) (*BlogId, error) {
	out := new(BlogId)
	err := c.cc.Invoke(ctx, "/blog.BlogService/CreatBlog", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BlogServiceServer interface {
	CreatBlog(context.Context, *Blog) (*BlogId, error)
...
func (UnimplementedBlogServiceServer) CreatBlog(context.Context, *Blog) (*BlogId, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatBlog not implemented")
}
...
func _BlogService_CreatBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Blog)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BlogServiceServer).CreatBlog(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blog.BlogService/CreatBlog",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BlogServiceServer).CreatBlog(ctx, req.(*Blog))
	}
...
var BlogService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreatBlog",
			Handler:    _BlogService_CreatBlog_Handler,
		},
		{
			MethodName: "ReadBlog",
