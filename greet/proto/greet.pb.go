...
var file_greet_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x61, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x32, 0xfa, 0x01,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x32, 0x3a, 0x0a, 0x0a, 0x41, 0x64,
...
var file_greet_proto_depIdxs = []int32{
	...
	2, // 4: greet.AddService.Add:input_type -> greet.AddRequest
	1, // 5: greet.GreetService.Greet:output_type -> greet.GreetResponse
	1, // 6: greet.GreetService.GreetManyTime:output_type -> greet.GreetResponse
	...
	3, // 9: greet.AddService.Add:output_type -> greet.AddResponse
